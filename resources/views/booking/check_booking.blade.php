        ...
        <main class="relative flex flex-col h-screen py-10 px-16 gap-8 items-center justify-between">
            ...
            <form action="{{ route('front.check_booking_details') }}" method="POST" class="flex flex-col w-full max-w-[782px] items-center rounded-[64px] p-[52px] gap-8 bg-white">
                ...
                <div class="flex flex-col items-center text-center gap-6">
                    ...
                    @if($errors->any())
                        <div class="text-white font-bold py-3 px-12 rounded-full bg-tutor-orange">
                            <ul>
                ...
                <div class="flex flex-col gap-6">
                    <div class="grid grid-cols-2 gap-6">
                        <label class="flex flex-col gap-4">
                            <p class="font-bold text-xl leading-[25px] text-tutor-grey">Booking Code</p>
                            <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                ...
                                <input type="text" name="booking_trx_id" id="" class="appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black" placeholder="Enter the code">
                            </div>
                        </label>
                        <label class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                ...
                                <div class="flex h-6 border border-tutor-border"></div>
                                <input type="tel" name="phone" id="phone-number" class="appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black" placeholder="+62 Enter the number">
                            </div>
                        </label>
                    </div>
                    <p class="font-['Poppins'] font-medium leading-[25px] text-tutor-grey text-center">Masukkan kode booking yang telah dikirim ke email Anda untuk memeriksa status pemesanan Anda.</p>
                </div>

    ...
    <main class="flex flex-col w-full max-w-[1280px] mx-auto px-16 gap-9 mt-16">
        <div class="flex flex-col gap-6">
            <div class="flex items-center gap-2">
                ...
                <p class="font-semibold leading-5 text-tutor-grey">></p>
                <p class="font-semibold text-lg leading-[22px] text-tutor-grey last:text-tutor-black">Payment Details</p>
            </div>
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('front.payment_store') }}" class="flex flex-col w-full rounded-[32px] overflow-hidden">
                ...
                <div class="flex flex-col rounded-[32px] p-8 gap-8 overflow-hidden bg-white">
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center rounded-full bg-tutor-bg-grey">
                            <label class="tab-link flex justify-center items-center w-full rounded-full border border-transparent py-4 px-8 text-tutor-grey transition-all duration-300 has-[:checked]:bg-tutor-orange/10 has-[:checked]:text-tutor-orange has-[:checked]:border-tutor-orange/10" data-target-tab="#Popular-Payment-Tab">
                                <span class="font-bold text-lg leading-[22px]">Popular Payment</span>
                                <input type="radio" name="tab" class="hidden" checked>
                            </label>
                            <label type="button" class="tab-link flex justify-center items-center w-full rounded-full border border-transparent py-4 px-8 text-tutor-grey transition-all duration-300 has-[:checked]:bg-tutor-orange/10 has-[:checked]:text-tutor-orange has-[:checked]:border-tutor-orange/10" data-target-tab="#Other-Tab">
                            ...
                            <div id="Popular-Payment-Tab" class="tab-content flex flex-col w-full gap-5">
                                <div class="group flex flex-col w-full rounded-3xl border border-[#F1F1F1] p-6 bg-white">
                                    <label class="flex items-center w-full justify-between h-10 overflow-hidden">
                                        ...
                                        <input type="radio" name="payment-method" id="" class="appearance-none w-6 h-6 rounded-full mr-[2px] ring-[1.5px] ring-tutor-border checked:ring-tutor-orange border-4 border-white bg-white checked:bg-tutor-orange transition-all duration-300">
                                    </label>
                                    <div class="content h-0 group-has-[:checked]:!h-[114px] transition-all duration-300 overflow-hidden">
                                        ...
                                        <div class="bank-details flex items-center justify-between">
                                            <div class="flex flex-col gap-[6px]">
                                                ...
                                                <p class="font-semibold text-lg leading-[22px] text-tutor-grey">PT Seaccount Angga</p>
                                            </div>
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <label class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                ...
                                <select name="customer_bank_name" id="" class="px-4 appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black">
                        ...
                        <label class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                ...
                                <input type="text" name="customer_bank_account" id="" class="appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black" placeholder="Atas Nama Siapa?">
                            </div>
                        </label>
                        <label class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                ...
                                <div class="flex h-6 border border-tutor-border"></div>
                                <input type="text" inputmode="numeric" name="customer_bank_number" id="" class="appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black" pattern="[0-9 ]*" title="Only numbers and spaces are allowed" placeholder="Nomor Rekening Kamu?">
                            </div>
                        </label>
                    </div>
                    <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <label class="relative flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">

    ...
    <main class="flex flex-col w-full max-w-[1280px] mx-auto px-16 gap-9 mt-16">
        <div class="flex flex-col gap-6">
            <div class="flex items-center gap-2">
                ...
                <p class="font-semibold text-lg leading-[22px] text-tutor-grey last:text-tutor-black">Pesanan Saya</p>
            </div>
        ...
        <div class="flex gap-9 mb-20">
            <div id="Details-tab" class="flex flex-col w-[670px] shrink-0 gap-9">
                <div id="Tab-Links" class="grid grid-cols-2 w-full max-w-[520px] gap-6">
                    <label class="tab-link group flex justify-between items-center w-full rounded-[18px] py-4 px-6 gap-2 bg-white transition-all duration-300 has-[:checked]:bg-tutor-black" data-target-tab="#Broadcast-Message-Tab">
                    ...
                    <label class="tab-link group flex justify-between items-center w-full rounded-[18px] py-4 px-6 gap-2 bg-white transition-all duration-300 has-[:checked]:bg-tutor-black" data-target-tab="#Order-Details-Tab">
                ...
                <div id="Tab-Contents" class="flex">
                    <div id="Broadcast-Message-Tab" class="tab-content flex flex-col w-full gap-9">
                        <div id="Delivery" class="flex flex-col rounded-[32px] p-8 gap-8 bg-white overflow-hidden">
                            <div class="flex items-center justify-between rounded-3xl border border-tutor-border p-6 gap-6">
                                ...
                                <div class="flex items-center rounded-lg p-2 gap-1 bg-tutor-red/10">
                                    ...
                                    <p class="font-bold leading-5 text-tutor-red">{{ $bookingDetails->product->duration }} month</p>
                                </div>
                            </div>

                            <div class="flex flex-col gap-6">
                                <div class="flex items-center justify-between">
                                    <h2 class="font-bold text-xl leading-[25px]">Broadcast Message</h2>
                                    @if($remainingSlots == 0)
                                    <p id="Badge" class="w-fit p-[12px_24px] rounded-full bg-[#3D7452] font-bold text-lg leading-[22px] text-white">Delivered</p>
                                    @else
                                    <p id="Badge" class="w-fit p-[12px_24px] rounded_full bg-[#007B9D] font-bold text-lg leading-[22px] text-white">Success</p>
                                    @endif
                                </div>
                                ...
                                <div class="message-card flex gap-4">
                                    ...
                                    <div class="flex flex-col flex-1 rounded-3xl rounded-tl-[4px] p-6 gap-6 bg-tutor-bg-grey">
                                        ...
                                        <span class="time font-bold leading-5 text-tutor-grey">
                                            {{ $message->created_at->format('M d, Y H:s')}}
                                        </span>
                                    </div>
                                </div>
                                @endforeach
                    ...
                    <div id="Order-Details-Tab" class="tab-content flex flex-col w-full hidden">
                        <div class="flex flex-col rounded-[32px] p-8 gap-8 bg-white overflow-hidden">
                            <div id="Order-Summary" class="flex flex-col gap-6">
                                ...
                                <div class="flex flex-col justify-between rounded-3xl border border-tutor-border p-6 gap-6">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4">
                                            <div class="flex w-[62px] h-[62px] shrink-0 rounded-xl overflow-hidden">
                                                <img src="{{ Storage::url($bookingDetails->product->photo) }}" class="w-full h-full object-contain" alt="logo">
                                    ...
                                    <div class="flex flex-col gap-4">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <p class="font-semibold text-lg leading-[22px] text-tutor-grey">Date</p>
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <p class="font-bold text-xl leading-[25px]">
                                            Rp {{ number_format($bookingDetails->product->price, 0, ',', '.') }}
                                            </p>
                                        </div>
                                        <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <p class="font-bold text-xl leading-[25px]">
                                            Rp {{ number_format($bookingDetails->total_tax_amount, 0, ',', '.') }}
                                            </p>
                                        </div>
                                        <div class="flex items-center justify-between">
                            ...
                            <div id="Personal-Information" class="flex flex-col gap-5">
                                ...
                                <label class="flex flex-col gap-4">
                                    ...
                                    <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                        ...
                                        <input type="text" value="{{ $bookingDetails->name }}" readonly class="appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black">
                                    </div>
                                </label>
                                <label class="flex flex-col gap-4">
                                    ...
                                    <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                        ...
                                        <div class="flex h-6 border border-tutor-border"></div>
                                        <input type="tel" value="{{ $bookingDetails->phone }}" readonly class="appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black">
                                    </div>
                                </label>
                                <label class="flex flex-col gap-4">
                                    ...
                                    <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                        ...
                                        <div class="flex h-6 border border-tutor-border"></div>
                                        <input type="email" value="{{ $bookingDetails->email }}" readonly class="appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black">
                                    </div>
                                </label>
                            </div>
                            <div id="Transfer-Informations" class="flex flex-col gap-5">
                                ...
                                <div class="group flex flex-col w-full rounded-3xl border border-[#F1F1F1] p-6 bg-white">
                                    <label class="flex items-center w-full justify-between h-10 overflow-hidden">
                                        ...
                                        <input type="radio" name="" checked readonly class="appearance-none w-6 h-6 rounded-full mr-[2px] ring-[1.5px] ring-tutor-border checked:ring-tutor-orange border-4 border-white bg-white checked:bg-tutor-orange transition-all duration-300">
                                    </label>
                                    <div class="content h-0 group-has-[:checked]:!h-[114px] transition-all duration-300 overflow-hidden">
                                        <hr class="border-tutor-border my-4">
                                        <div class="bank-details flex items-center justify-between">
                                            <div class="flex flex-col gap-[6px]">
                                                <p class="font-semibold text-lg leading-[22px] text-tutor-grey">Transfer to</p>
                                                <p class="Transfer-To font-bold text-xl leading-[25px]">1935 0009 1200</p>
                                                <p class="font-semibold text-lg leading-[22px] text-tutor-grey">PT Nigger</p>
                                            </div>
                                            <button type="button" class="copy-btn flex items-center gap-[6px]" onclick="copyTransferTo(this)">
                                                ...
                                                <span class="font-semibold text-lg leading-[22px] text-tutor-orange">Copy</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <label class="flex flex-col gap-4">
                                    <p class="font-bold text-xl leading-[25px] text-tutor-grey">Bank Name</p>
                                    <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                        <img src="{{ asset('assets/images/icons/bank-black.svg') }}" class="w-6 h-6 flex shrink-0" alt="icon">
                                        <div class="flex h-6 border border-tutor-border -mr-4"></div>
                                        <select class="px-4 appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black pointer-events-none">
                                            <option value="{{ $bookingDetails->customer_bank_name }}" selected>
                                            {{ $bookingDetails->customer_bank_name }}
                                            </option>
                                        </select>
                                    </div>
                                </label>
                                <label class="flex flex-col gap-4">
                                    <p class="font-bold text-xl leading-[25px] text-tutor-grey">Bank Account Name</p>
                                    <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                        <img src="{{ asset('assets/images/icons/user-octagon-black.svg') }}" class="w-6 h-6 flex shrink-0" alt="icon">
                                        <div class="flex h-6 border border-tutor-border"></div>
                                        <input type="text" value="{{ $bookingDetails->customer_bank_account }}" readonly class="appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black" placeholder="Atas Nama Siapa?">
                                    </div>
                                </label>
                                <label class="flex flex-col gap-4">
                                    <p class="font-bold text-xl leading-[25px] text-tutor-grey">Bank Account Number</p>
                                    <div class="flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                        <img src="{{ asset('assets/images/icons/blend-black.svg') }}" class="w-6 h-6 flex shrink-0" alt="icon">
                                        <div class="flex h-6 border border-tutor-border"></div>
                                        <input type="text" value="{{ $bookingDetails->customer_bank_number }}" readonly class="appearance-none outline-none bg-tutor-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-tutor-black" pattern="[0-9 ]*" title="Only numbers and spaces are allowed" placeholder="Nomor Rekening Kamu?">
                                    </div>
                                </label>
                            </div>
                            <div id="Payment-Proof" class="flex flex-col gap-4">
                                <h2 class="font-bold text-xl leading-[25px]">Payment Proof</h2>
                                <div class="relative flex items-center rounded-3xl border border-tutor-border p-6 gap-4 bg-tutor-bg-grey focus-within:border-tutor-orange transition-all duration-300">
                                    <img src="{{ asset('assets/images/icons/gallery-import-black.svg') }}" class="w-6 h-6 flex shrink-0" alt="icon">
                                    <div class="flex h-6 border border-tutor-border"></div>
                                    <img src="{{ Storage::url($bookingDetails->proof) }}", class="w-full h-full object-contain", alt="proof">
                                    <a href="#" class="font-semibold text-lg leading-[22px] text-tutor-orange text-nowrap">View Image</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="Member-Status" class="flex flex-col w-full max-w-[446px] rounded-[32px] overflow-hidden">
                <div class="relative flex items-center text-center px-6 pt-8 pb-16 -mb-8 bg-[linear-gradient(113.19deg,#E25520_0%,#A83279_100.41%)] overflow-hidden">
                    ...
                    <div class="relative w-full">
                        ...
                        <p class="font-bold text-[32px] leading-10 text-white">
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <p class="font-semibold text-lg leading-[22px] text-tutor-grey">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="w-h h-16 flex shrink-0 rounded-full overflow-hidden">
                                <img src="{{ asset('assets/image/icons/waiting-member.svg') }}" class="w-full h-full object-cover" alt="icon">
                            </div>
                            <p class="font-semibold text-xl italic leading-[25px] text-tutor-grey">Waiting someone...</p>
                        </div>
                        @endfor
    ...
    <main class="flex flex-col h-full items-center justify-center px-16 py-16">
        ...
        <div class="flex flex-col w-full max-w-[762px] mt-6 rounded-[32px] overflow-hidden">
            ...
            <div class="relative flex flex-col items-center rounded-[32px] p-[52px] gap-8 bg-white overflow-hidden">
                <div class="flex items-center w-fit rounded-full p-[12px_24px] gap-[6px] bg-tutor-yellow">
                ...
                <div class="flex flex-col text-center gap-4">
                    <p class="font-Grifter font-bold text-[32px] leading-[50px] text-[#161616]">Akses grup tutor tertunda karena pesananmu sedang diverifikasi!</p>
                    <p class="font-['Poppins'] font-medium leading-[25px] text-tutor-grey">Sabar ya, Pesanan kamu sedang kami cek🙌🏻.  setelah terverifikasi, kamu akan otomatis masuk ke grup tutor yang kami sediakan 😉 </p>
                </div>
            </div>
        </div>
    </main>

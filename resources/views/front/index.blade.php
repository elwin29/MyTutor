...
@section('content')
    ...
    <header class="flex flex-col items-center py-[100px] w-full max-w-[1280px] mx-auto px-16">
        <div id="Badge" class="flex items-center w-fit rounded-full p-2 pr-6 gap-3 bg-tutor-black">
        ...
        <h1 class="font-Grifter text-[62px] text-center mt-[42px] flex justify-center flex-wrap">
            <span class="!block">tutor Akun</span> 
        ...
        <p class="font-medium text-lg text-center text-tutor-grey">
        ...
        <div class="flex items-center justify-center gap-6 mt-16">
            <a href="#" class="flex items-center rounded-full h-[60px] w-fit px-9 gap-[6px] bg-tutor-orange">
            ...
            <a href="#" class="flex items-center rounded-full h-[60px] w-fit px-9 gap-[6px] bg-white border border-tutor-border">
                <span class="font-bold text-lg leading-5">Lihat Cara Pesan</span>
            </a>
        </div>
    </header>
    <section id="Stats" class="w-full flex justify-center bg-tutor-black">
        <div class="flex items-center gap-8 w-full max-w-[1280px] px-16 py-[42px]">
            <div class="flex flex-col w-[222px] gap-[6px] text-center">
                ...
                <p class="font-medium text-xl leading-[25px] text-tutor-violet">Total User</p>
            </div>
            ...
            <div class="flex flex-col w-[222px] gap-[6px] text-center">
                ...
                <p class="font-medium text-xl leading-[25px] text-tutor-violet">Happy Client</p>
            </div>
            <img src="{{ asset('assets/images/icons/star-divider-white.svg') }}" class="w-6 flex shrink-0" alt="icon">
            <div class="flex flex-col w-[222px] gap-[6px] text-center">
                <p class="font-Grifter font-bold text-[42px] leading-[44px] text-white">12</p>
                <p class="font-medium text-xl leading-[25px] text-tutor-violet">Total Services</p>
            </div>
            <img src="{{ asset('assets/images/icons/star-divider-white.svg') }}" class="w-6 flex shrink-0" alt="icon">
            <div class="flex flex-col w-[222px] gap-[6px] text-center">
                <p class="font-Grifter font-bold text-[42px] leading-[44px] text-white">4.920+</p>
                <p class="font-medium text-xl leading-[25px] text-tutor-violet">Total Transactions</p>
            </div>
        </div>
    </section>
        ...
        <section class="Content relative flex flex-col w-full max-w-[1280px] px-16 mx-auto gap-8 py-[100px]">
            <div class="flex items-center justify-between">
                <div class="flex flex-col gap-5">
                    <h2 class="font-bold text-xl leading-[25px] text-tutor-red">Our Services</h2>
                    <p class="font-Grifter font-bold text-4xl leading-[37px]">Beragam Account bisa kamu nikmati 🥳 </p>
                </div>
                <a href="#" class="flex items-center rounded-full h-[60px] w-fit py-3 px-9 gap-[6px] bg-white border border-tutor-border">
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                @forelse($newProducts as $itemNewProduct)
                    ...
                    <div class="flex flex-col p-6 gap-6">
                        ...
                        <div class="flex flex-col rounded-3xl border border-tutor-border p-4 gap-4">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center rounded-lg p-2 gap-1 bg-tutor-red/10">
                                    ...
                                    <p class="font-bold leading-5 text-tutor-red">
                                        {{ $itemNewProduct->duration }}
                                    </p>
                                </div>
                            </div>
                        ...
                        <a href="{{ route('front.details', $itemNewProduct->slug) }}" class="flex items-center rounded-full h-[60px] px-9 w-full gap-[6px] bg-tutor-orange justify-center">
                            <span class="font-bold text-lg leading-5 text-white">Pesan Sekarang</span>
                        </a>
                    </div>
                    </div>
            ...
            <button class="flex items-center rounded-full border border-tutor-orange/10 bg-tutor-orange/10 h-[60px] px-9 gap-2 justify-center">
                <span class="font-bold leading-5 text-tutor-orange">Lihat Semua</span>
        ...
        <div class="relative flex w-full h-[inherit]">
            <div class="sticky top-0 flex flex-col w-full max-w-[510px] gap-[54px] h-fit">
                <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-5">
                        <h2 class="font-bold text-xl leading-[25px] text-tutor-red">How it Works</h2>
                        <p class="font-Grifter font-bold text-4xl leading-[37px]">Prosesnya Mudah & Cepat</p>
                    </div>
                    <p class="font-medium text-lg text-tutor-grey">Kami berkomitmen memberikan layanan terbaik dan pengalaman menarik bagi setiap pelanggan setia kami.</p>
                    <div class="grid grid-cols-2 gap-6">
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                            <p class="font-medium text-lg leading-[22px] text-tutor-grey">Data pribadi aman</p>
                        </div>
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                            <p class="font-medium text-lg leading-[22px] text-tutor-grey">beragam pembayaran</p>
                        </div>
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                            <p class="font-medium text-lg leading-[22px] text-tutor-grey">Akun Resmi & legal</p>
                        </div>
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                            <p class="font-medium text-lg leading-[22px] text-tutor-grey">24/7 Customer services</p>
                        </div>
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                            <p class="font-medium text-lg leading-[22px] text-tutor-grey">Lebih hemat 50%</p>
                        ...
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                            <p class="font-medium text-lg leading-[22px] text-tutor-grey">Dan masih banyak lainnya</p>
                        </div>
                    </div>
                </div>
                <a href="#" class="flex items-center rounded-full h-[60px] w-fit px-9 gap-[6px] bg-tutor-orange">
        ...
        <div class="flex flex-col w-full h-fit max-w-[560px] gap-8">
            <div class="card flex flex-col w-full rounded-[32px] bg-white overflow-hidden">
                <div class="flex flex-col gap-6 p-6">
                    <div class="flex items-center gap-4">
                        <span class="flex w-11 shrink-0 rounded-[100px] h-[56px] bg-tutor-orange/10 justify-center items-center font-bold text-[32px] leading-[40px] text-tutor-orange">
                            1
                        </span>
                        <p class="font-Grifter font-bold text-2xl leading-[25px]">Select Product</p>
                    </div>
                    <p class="font-medium text-lg leading-8 text-tutor-grey">Pilih layanan langganan yang ingin Anda patungi. Kami menyediakan berbagai pilihan seperti Netflix, Spotify, dan Disney+ dengan harga terjangkau</p>
                </div>
            ...
            <div class="card flex flex-col w-full rounded-[32px] bg-white overflow-hidden">
                <div class="flex flex-col gap-6 p-6">
                    ...
                    <p class="font-medium text-lg leading-8 text-tutor-grey">Lakukan pembayaran sesuai nominal yang ditentukan. Anda bisa bergabung dengan grup tutor bersama teman atau pengguna lain.</p>
                </div>
                <div class="flex w-full h-[232px] overflow-hidden">
            ...
            <div class="card flex flex-col w-full rounded-[32px] bg-white overflow-hidden">
                <div class="flex flex-col gap-6 p-6">
                    ...
                    <p class="font-medium text-lg leading-8 text-tutor-grey">Setelah pembayaran, Anda akan dimasukkan ke dalam grup tutor sesuai layanan yang dipilih. Nikmati akses layanan bersama dengan biaya lebih hemat.</p>
                </div>
                <div class="flex w-full h-[232px] overflow-hidden">
    ...
    <section id="Payment-Method" class="bg-[linear-gradient(69.16deg,#FFFFFF_0.82%,rgba(255,255,255,0)_52.97%)]">
        <div class="Content flex flex-col py-[100px] w-full max-w-[1280px] mx-auto px-16 gap-9">
            <div class="flex flex-col items-center text-center">
                <div class="flex flex-col gap-5">
                    <h2 class="font-bold text-xl leading-[25px] text-tutor-red">Payment Methods</h2>
                    <p class="font-Grifter font-bold text-4xl leading-[37px]">Beragam Metode pembayaran</p>
                    <div class="flex items-center justify-center gap-6">
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                            <p class="font-medium text-lg leading-[22px] text-tutor-grey">Bank Transfer</p>
                        </div>
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                            <p class="font-medium text-lg leading-[22px] text-tutor-grey">Virtual Account</p>
                        </div>
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                            <p class="font-medium text-lg leading-[22px] text-tutor-grey">Digital Wallet</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="Happy-Customer" class="py-[100px] bg-[linear-gradient(180deg,rgba(255,255,255,0.5)_50%,rgba(243,239,245,0)_100%)]">
        <div class="flex flex-col gap-5 text-center px-16">
            <h2 class="font-bold text-xl leading-[25px] text-tutor-red">Happy Customers</h2>
            ...
            <div id="Top-Slider" class="group flex flex-nowrap flex-row">
                <div class="flex flex-row w-max gap-6 flex-nowrap animate-[slide_50s_linear_infinite] pl-6">
                    <div class="card flex flex-col w-[322px] h-full shrink-0 rounded-3xl p-6 gap-6 bg-white">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-semibold leading-5 text-tutor-grey">Netflix Subscription</p>
                            </div>
                        </div>
                        <hr class="border-tutor-border">
                        <div class="flex flex-col gap-6 justify-between h-full">
                            <p class="font-semibold leading-[28px]">"tutor akun di sini terpercaya, gak nyesel! Netflix dan Disney+ lancar jaya, harga terjangkau pula!"</p>
                    ...
                    <div class="card flex flex-col w-[322px] h-full shrink-0 rounded-3xl p-6 gap-6 bg-white">
                        ...
                        <hr class="border-tutor-border">
                        <div class="flex flex-col gap-6 justify-between h-full">
                            <p class="font-semibold leading-[28px]">"Hemat banget tutor akun di sini! Nonton Netflix dan Spotify jadi lebih terjangkau. Proses cepat dan tanpa ribet!"</p>
                            <div class="flex items-center gap-[2px]">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                    ...
                    <div class="card flex flex-col w-[322px] h-full shrink-0 rounded-3xl p-6 gap-6 bg-white">
                        ...
                        <hr class="border-tutor-border">
                        <div class="flex flex-col gap-6 justify-between h-full">
                            <p class="font-semibold leading-[28px]">“Layanan tutor akun terbaik! Bisa langganan Netflix dan Disney+ jadi lebih murah. Proses mudah dan aman, rekomendasi banget!”</p>
                            <div class="flex items-center gap-[2px]">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                    ...
                    <div class="card flex flex-col w-[322px] h-full shrink-0 rounded-3xl p-6 gap-6 bg-white">
                        ...
                        <hr class="border-tutor-border">
                        <div class="flex flex-col gap-6 justify-between h-full">
                            <p class="font-semibold leading-[28px]">"Layanan top! Dulu nonton Netflix mahal, sekarang lebih hemat dengan tutor akun. Proses gampang dan cepat!"</p>
                            <div class="flex items-center gap-[2px]">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                    ...
                    <div class="card flex flex-col w-[322px] h-full shrink-0 rounded-3xl p-6 gap-6 bg-white">
                        ...
                        <hr class="border-tutor-border">
                        <div class="flex flex-col gap-6 justify-between h-full">
                            <p class="font-semibold leading-[28px]">"Bisa nikmatin Spotify dan Disney+ murah banget! tutor di sini bikin semua jadi mudah dan terpercaya."</p>
                            <div class="flex items-center gap-[2px]">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
                                <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-6 flex shrink-0" alt="star">
    ...
    <section id="FAQ" class="py-[100px] bg-[linear-gradient(270deg,rgba(255,255,255,0.5)_50%,rgba(243,239,245,0)_100%)]">
        <div class="content flex flex-col w-full max-w-[1280px] mx-auto px-16 gap-8">
            <div class="flex flex-col gap-5 text-center px-16">
                <h2 class="font-bold text-xl leading-[25px] text-tutor-red">Frequently Asked Questions</h2>
                ...
                <div id="Left-Cards" class="flex flex-col gap-6">
                    <div class="faq-card flex flex-col rounded-3xl p-8 gap-4 bg-white">
                        ...
                        <div class="accordion group flex flex-col has-[:checked]:!h-11 overflow-hidden transition-all duration-300">
                            <label class="flex items-center gap-4 justify-between min-h-[38px]">
                                ...
                                <h3 class="font-Grifter text-lg leading-[25px]">When does the subscription period at tutor become active?</h3>
                    ...
                    <div class="faq-card flex flex-col rounded-3xl p-8 gap-4 bg-white">
                        ...
                        <div class="accordion group flex flex-col has-[:checked]:!h-11 overflow-hidden transition-all duration-300">
                            <label class="flex items-center gap-4 justify-between min-h-[38px]">
                                <input type="checkbox" class="hidden" checked>
                                <h3 class="font-Grifter text-lg leading-[25px]">What payment methods are available on tutor?</h3>
                                <img src="{{ asset('assets/images/icons/arrow-head-down-black.svg') }}" class="w-6 flex shrink-0 group-has-[:checked]:-rotate-180 transition-all duration-300" alt="icon">
                            </label>
                            <div class="accordion-content mt-4">
                                <p class="font-semibold leading-[25px]">Your subscription becomes active immediately after the payment is successfully processed. You will receive a confirmation email with the details</p>
                ...
                <div id="Right-Cards" class="flex flex-col gap-6">
                    <div class="faq-card flex flex-col rounded-3xl p-8 gap-4 bg-white">
                        ...
                        <div class="accordion group flex flex-col has-[:checked]:!h-11 overflow-hidden transition-all duration-300">
                            <label class="flex items-center gap-4 justify-between min-h-[38px]">
                                <input type="checkbox" class="hidden" checked>
                                <h3 class="font-Grifter text-lg leading-[25px]">How do I proceed with renewing my subscription on tutor?</h3>
                                <img src="{{ asset('assets/images/icons/arrow-head-down-black.svg') }}" class="w-6 flex shrink-0 group-has-[:checked]:-rotate-180 transition-all duration-300" alt="icon">
                            </label>
                            <div class="accordion-content mt-4">
                                <p class="font-semibold leading-[25px]">Your subscription becomes active immediately after the payment is successfully processed. You will receive a confirmation email with the details</p>
        ...
        <div class="flex flex-col w-full max-w-[1280px] px-[52px] mx-auto gap-[52px]">
            <div class="flex gap-[72px]">
                <div class="flex flex-col gap-6 w-full max-w-[349px] items-start">
                    ...
                    <p class="font-medium leading-[25px] text-tutor-grey">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
                </div>
                <div class="flex gap-[52px]">
                    <ul class="flex flex-col gap-4 min-w-[165px]">
                        <p class="font-semibold leading-5">Popular Services</p>
                        <li class="font-medium leading-5 text-tutor-grey">
                            <a href="#" class="hover:text-tutor-black transition-all duration-300">Home</a>
                        </li>
                        <li class="font-medium leading-5 text-tutor-grey">
                            <a href="#" class="hover:text-tutor-black transition-all duration-300">Layanan</a>
                        </li>
                        <li class="font-medium leading-5 text-tutor-grey">
                            <a href="#" class="hover:text-tutor-black transition-all duration-300">Cara Pesan</a>
                        </li>
                        <li class="font-medium leading-5 text-tutor-grey">
                            <a href="#" class="hover:text-tutor-black transition-all duration-300">Testimoni</a>
                        </li>
                        <li class="font-medium leading-5 text-tutor-grey">
                            <a href="#" class="hover:text-tutor-black transition-all duration-300">FAQ</a>
                        </li>
                    </ul>
                    <ul class="flex flex-col gap-4 min-w-[165px]">
                        <p class="font-semibold leading-5">Company</p>
                        <li class="font-medium leading-5 text-tutor-grey">
                            <a href="#" class="hover:text-tutor-black transition-all duration-300">About Us</a>
                        </li>
                        <li class="font-medium leading-5 text-tutor-grey">
                            <a href="#" class="hover:text-tutor-black transition-all duration-300">Our Contact</a>
                        </li>
                        <li class="font-medium leading-5 text-tutor-grey">
                            <a href="#" class="hover:text-tutor-black transition-all duration-300">Term Policy</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="flex items-center">
                <p class="w-full font-medium leading-5 text-tutor-grey">©2024 tutor. All Rights Reserved</p>
                ...
                <div class="w-full flex justify-end">
                    <a href="" class="font-medium leading-5 text-tutor-grey text-nowrap">Terms & Conditions</a>
                </div>
            </div>
        </div>
    </footer>

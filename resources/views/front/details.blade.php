    ...
    <main class="flex flex-col w-full max-w-[1280px] mx-auto px-16 gap-9 mt-16">
        ...
        <div class="flex gap-9 mb-20">
                    ...
                    <div class="flex flex-col p-8 gap-6">
                        ...
                        <div class="flex flex-col rounded-3xl border border-tutor-border p-4 gap-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-semibold text-lg leading-[22px] text-tutor-grey">/person</span></p>
                                <div class="flex items-center rounded-lg p-2 gap-1 bg-tutor-red/10">
                                    ...
                                    <p class="font-bold leading-5 text-tutor-red">{{$product->duration}}</p>
                                </div>
                            </div>
                            <hr class="border-tutor-border">
                            <div class="flex items-center gap-2">
                                <img src="{{asset('assets/images/icons/verify-green.svg') }}" class="w-[18px] flex shrink-0" alt="icon">
                                <p class="font-medium text-lg leading-[22px] text-tutor-grey">Lorem Ipsum~</p>
                            </div>
                        </div>
                        <div class="flex flex-col gap-3">
                            <h2 class="font-bold text-xl leading-[25px]">About {{$product->name}}</h2>
                            <p class="font-semibold text-lg leading-[32px] text-tutor-grey">
                                {{ $product->about }}
                            </p>
                        </div>
                        <div class="flex flex-col gap-3">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="font-semibold leading-5">5219+ <span class="text-tutor-grey">Users Has Joined 🔥</span> </p>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col rounded-[32px] p-8 gap-6 bg-white">
                    <div class="flex items-center rounded-full bg-tutor-bg-grey">
                        <label class="tab-link flex justify-center items-center w-full rounded-full border border-transparent py-4 px-8 text-tutor-grey transition-all duration-300 has-[:checked]:bg-tutor-orange/10 has-[:checked]:text-tutor-orange has-[:checked]:border-tutor-orange/10" data-target-tab="#How-It-Works-Tab">
                            <span class="font-bold text-lg leading-[22px]">How it Works</span>
                            <input type="radio" name="tab" class="hidden" checked>
                        </label>
                        <label class="tab-link flex justify-center items-center w-full rounded-full border border-transparent py-4 px-8 text-tutor-grey transition-all duration-300  has-[:checked]:bg-tutor-orange/10 has-[:checked]:text-tutor-orange has-[:checked]:border-tutor-orange/10" data-target-tab="#Reviews-Tab">
                    ...
                    <div class="flex">
                        <div id="How-It-Works-Tab" class="tab-content flex flex-col gap-5">
                            <ol class="font-semibold text-lg leading-9 text-tutor-grey list-decimal pl-5">
                            ...
                            <div class="flex items-center rounded-xl p-4 gap-3 bg-tutor-red/10">
                                <img src="{{asset('assets/images/icons/notification-box-red.svg') }}" class="w-[52px] h-[52px] flex shrink-0" alt="icon">
                                <p class="font-semibold leading-[25px] text-tutor-red">The balance will be refunded if the required number of people is not met within the specified time.</p>
                            </div>
                        </div>
            ...
            <div id="Price-Details" class="flex flex-col w-full h-fit rounded-[32px] p-8 gap-8 bg-white overflow-hidden">
                ...
                <a href="{{ route('front.booking', $product->slug) }}" class="flex items-center rounded-full h-[60px] px-9 w-full gap-[6px] bg-tutor-orange justify-center">
